"""
Константы для модуля оптимизации портфеля.
...
class FinancialConstants:
    ...
    RISK_FREE_RATE: float = 0.08  # 8% - базовая безрисковая ставка
    BASE_RETURN: float = 0.08  # Базовая ожидаемая доходность
...
class RiskPremiums:
    ...
    BASE_RISK: float = 0.15  # 15% - базовый риск
    ...
    MIN_RISK: float = 0.08  # 8% - минимальный риск
